...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ubs-user-ubs-user-module"], {
    ...
    var UserOrdersService = /*#__PURE__*/function () {
      ...
      _createClass(UserOrdersService, [{
        ...
        value: function deleteOrder(orderId) {
          return this.http["delete"]("".concat(this.url, "/delete-order/").concat(orderId));
        }
      }]);
      ...
      _createClass(UbsUserBonusesComponent, [{
        ...
        value: function getBonusesData() {
          ...
          this.bonusesService.getUserBonuses().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy)).subscribe(function (res) {
            _this.bonusesList = res.ubsUserBonuses;
            _this.dataSource.data = res.ubsUserBonuses;
            _this.totalBonuses = res.userBonuses;
            _this.isLoading = false;
          }, function (error) {
            _this.isLoading = false;

            _this.snackBar.openSnackBar('Oops, something went wrong. Please reload page or try again later.');
        ...
        value: function sortData(sort) {
          ...
          this.dataSource.data = data.sort(function (a, b) {
            ...
            return _this2.compare(new Date(a.dateOfEnrollment).getDate(), new Date(b.dateOfEnrollment).getDate(), isAsc);
          });
        }
      }, {
        key: "compare",
  ...
  function srcAppUbsUserUbsUserMessagesUbsUserMessagesComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_div_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_div_11_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_div_12_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_div_13_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-expansion-panel", 21);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_Template_mat_expansion_panel_click_0_listener() {
        ...
        })("opened", function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_Template_mat_expansion_panel_opened_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);

          var ctx_r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r14.panelOpenState = true;
        })("closed", function UbsUserMessagesComponent_div_19_mat_expansion_panel_2_Template_mat_expansion_panel_closed_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r13);
    ...
    function UbsUserMessagesComponent_div_19_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("pageChange", function UbsUserMessagesComponent_div_19_Template_pagination_controls_pageChange_5_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r17);
      ...
      _createClass(UbsUserMessagesComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.params.subscribe(function (val) {
            _this3.page = +_this3.route.snapshot.paramMap.get('pageId');

            _this3.subscribeToLangChange();
          });
        }
      }, {
        ...
        value: function subscribeToLangChange() {
          ...
          this.localStorageService.languageBehaviourSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroyed$)).subscribe(function () {
            return _this4.fetchNotification();
          });
        }
      }, {
        ...
        value: function fetchNotification() {
          ...
          this.userMessagesService.getNotification(this.page - 1, this.pageSize).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy)).subscribe(function (response) {
            _this5.notifications = response.page;
            _this5.count = response.totalElements;
            _this5.isAnyMessages = _this5.notifications.length > 0;
            _this5.isLoadSpinner = _this5.isLoadBar = false;
          }, function (error) {
            console.log(error);
          });
        }
        ...
        value: function setRead(notificationId, isRead) {
          ...
          if (isGetNotificationBody) {
            ...
            this.userMessagesService.setReadNotification(notificationId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy)).subscribe(function (response) {
              var findNotification = _this6.notifications.find(function (item) {
                return item.id === notificationId;
              });

              findNotification.body = response.body;
              findNotification.isOpen = true;
              _this6.isLoadSmallSpinner = false;
            });
          }
        }
      }, {
    ...
    UbsUserMessagesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_12__["TranslatePipe"], ngx_pagination__WEBPACK_IMPORTED_MODULE_10__["PaginatePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_6__["DatePipe"]],
  ...
  function srcAppUbsUserUbsUserOrderDetailsUbsUserOrderDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _shared_localized_currency_pipe_localized_currency_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    function UbsUserOrderDetailsComponent_tr_34_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "tr", 21);
    ...
    function UbsUserOrderDetailsComponent_ol_44_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserOrderDetailsComponent_li_68_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserOrderDetailsComponent_ng_template_79_Template(rf, ctx) {
      if (rf & 1) {
    ...
    UbsUserOrderDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      pipes: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_4__["TranslatePipe"], _shared_localized_currency_pipe_localized_currency_pipe__WEBPACK_IMPORTED_MODULE_5__["LocalizedCurrencyPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CurrencyPipe"]],
  ...
  function srcAppUbsUserUbsUserOrdersListUbsUserOrdersListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_user_orders_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    ...
    var _ubs_user_order_details_ubs_user_order_details_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    ...
    var _shared_localized_currency_pipe_localized_currency_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ../../shared/localized-currency-pipe/localized-currency.pipe */
    "./src/app/shared/localized-currency-pipe/localized-currency.pipe.ts");
    ...
    function UbsUserOrdersListComponent_mat_expansion_panel_2_div_17_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UbsUserOrdersListComponent_mat_expansion_panel_2_div_17_Template_button_click_1_listener() {
          ...
          return ctx_r7.deleteCard(order_r2.generalOrderInfo.id);
        });
    ...
    function UbsUserOrdersListComponent_mat_expansion_panel_2_div_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserOrdersListComponent_mat_expansion_panel_2_div_19_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserOrdersListComponent_mat_expansion_panel_2_div_20_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function UbsUserOrdersListComponent_mat_expansion_panel_2_Template(rf, ctx) {
      if (rf & 1) {
        var _r12 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-expansion-panel", 10);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UbsUserOrdersListComponent_mat_expansion_panel_2_Template_mat_expansion_panel_click_0_listener() {
          ...
          return ctx_r11.changeCard(order_r2.generalOrderInfo.id);
        });
    ...
    var UbsUserOrdersListComponent = /*#__PURE__*/function () {
      function UbsUserOrdersListComponent(userOrdersService, dialog) {
      ...
      _createClass(UbsUserOrdersListComponent, [{
        ...
        value: function isOrderDone(order) {
          return order.generalOrderInfo.orderStatus === 'ON_THE_ROUTE' || order.generalOrderInfo.orderStatus === 'CONFIRMED' || order.generalOrderInfo.orderStatus === 'DONE';
        }
      }, {
        key: "changeCard",
        ...
        key: "deleteCard",
        value: function deleteCard(orderId) {
    ...
    UbsUserOrdersListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 2,
      consts: [["class", "header_list", 4, "ngIf"], ["multi", "false"], [3, "click", 4, "ngFor", "ngForOf"], [1, "header_list"], [1, "header_list-num"], [1, "header_list-date"], [1, "header_list-status"], [1, "header_list-paymentStatus"], [1, "header_list-paymentAmount"], [1, "empty-div"], [3, "click"], [1, "mat-content-wrapper"], [1, "order_list-num"], [1, "order_list-date"], [1, "order_list-status"], [1, "order_list-paymentStatus"], [1, "order_list-paymentAmount"], [1, "btns_group"], ["class", "btn_grid_cancel", 4, "ngIf"], ["class", "btn_grid_pay", 4, "ngIf"], ["class", "btn_grid_order", 4, "ngIf"], ["class", "description", 4, "ngIf"], [1, "btn_grid_cancel"], [1, "btn_cancel", 3, "click"], [1, "btn_grid_pay"], [1, "btn_pay"], [1, "btn_grid_order"], [1, "btn_order"], [1, "description"], [3, "order"]],
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UbsUserOrdersListComponent, [{
        ...
        return [{
          type: _services_user_orders_service__WEBPACK_IMPORTED_MODULE_1__["UserOrdersService"]
        }, {
      ...
      _createClass(UbsUserOrdersComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userOrdersService.getAllUserOrders().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["takeUntil"])(this.destroy), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (err) {
            _this7.snackBar.openSnackBar('Oops, something went wrong. Please reload page or try again later.');

            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["throwError"])(err);
          })).subscribe(function (item) {
            _this7.orders = item;
            _this7.loading = true;
            _this7.currentOrders = _this7.orders.filter(function (order) {
              return order.orderStatus !== 'DONE' && order.orderStatus !== 'CANCELLED';
            });
            _this7.orderHistory = _this7.orders.filter(function (order) {
              return order.orderStatus === 'DONE' || order.orderStatus === 'CANCELLED';
            });
          });
        }
      ...
      _createClass(UbsUserProfilePageComponent, [{
        ...
        value: function getUserData() {
          ...
          this.clientProfileService.getDataClientProfile().subscribe(function (res) {
            ...
            _this8.userProfile = _this8.composeFormData(res);
            _this8.userProfile.addressDto = (_a = _this8.userProfile.addressDto) !== null && _a !== void 0 ? _a : _this8.defaultAddress;
            ...
            _this8.snackBar.openSnackBar('ubs-client-profile.error-message');
          });
        }
      }, {
        key: "userInit",
        ...
        value: function onSubmit() {
          ...
          if (this.userForm.valid) {
            ...
            this.clientProfileService.postDataClientProfile(submitData).subscribe(function (res) {
              ...
              _this9.userProfile = _this9.composeFormData(res);
            }, function (err) {
              _this9.isFetching = false;

              _this9.snackBar.openSnackBar('ubs-client-profile.error-message');
            });
          } else {
            this.isEditing = true;
          }
  ...
  function srcAppUbsUserUbsUserSidebarUbsUserSidebarComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var UbsUserSidebarComponent = /*#__PURE__*/function (_src_app_shared_ubs_b) {
      ...
      var _super = _createSuper(UbsUserSidebarComponent);
      ...
      function UbsUserSidebarComponent(service, breakpointObserver, jwtService) {
        ...
        _this10 = _super.call(this, service, breakpointObserver, jwtService);
        _this10.service = service;
        _this10.breakpointObserver = breakpointObserver;
        _this10.jwtService = jwtService;
        _this10.listElementsUser = [{
      ...
      _createClass(UbsUserComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.localStorageService.languageBehaviourSubject.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["takeUntil"])(this.destroy)).subscribe(function (lang) {
            _this11.translate.setDefaultLang(lang !== 'en' && lang !== 'ua' ? 'ua' : lang);
          });
        }
      }, {
        key: "ngOnDestroy",
